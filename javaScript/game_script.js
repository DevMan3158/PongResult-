function PongGame(canvas) {
    ...
    function drawEverything() {
        ...
        colorRect(0, 0, canvas.width, canvas.height, '#142654');

        if (showingWinScreen) {
            canvasContext.fillStyle = 'white';

            if (player1Score >= WINNING_SCORE) {
                canvasContext.fillText("Joueur Gauche à Gagné", 350, 200);
            } else if (player2Score >= WINNING_SCORE) {
                canvasContext.fillText("Joueur Droite à Gagné", 350, 200);
            }

            canvasContext.fillText("Cliquer pour recommencer", 350, 500);
            return;
        }
        ...
        colorRect(canvas.width - PADDLE_THICKNESS, paddle2Y, PADDLE_THICKNESS, PADDLE_HEIGHT, '#FF2626');
